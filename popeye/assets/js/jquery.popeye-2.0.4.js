...
(function ($) {
    ...
    $.fn.popeye = function (options) {
        ...
        return this.each(function(){
			...
			$(this).find('.ppy-active').width( opts.width );
			$(this).find('.ppy-stage').width( opts.width );
			$(this).find('.ppy-stage').height( opts.height );
            ...
            for(var i=0; i<img.length; i++) {
                var extcap = $self.find('.ppy-imglist .ppy-img').eq(i).find('.ppy-extcaption');
            ...
            //------------------------------------------------------------------
                ...
                function showImage(i) {
                    ...
                    allPpy.css('z-index',opts.zindex-100);
    ...
    $.fn.popeye.defaults = {
        ...
        zindex:     200,              //z-index of the expanded popeye-box. enter a z-index that works well with your site and doesn't overlay your site's navigational elements like dropdowns
