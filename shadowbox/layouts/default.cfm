...
<cfsilent>
	...
	<cfset local.rc		= rc>
	<!--- headers --->
	<cfif not StructKeyExists(request,"header_meldgallery_global")>
		<cfset request.header_meldgallery_global = true />
...
<cfoutput><div class="meld-gallery clearfix">#body#</div></cfoutput>
